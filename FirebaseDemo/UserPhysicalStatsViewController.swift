...
class UserPhysicalStatsViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc func textFieldChanged(_ target:UITextField) {
        ...
        if formFilled {
            ...
            let formComplete = (unwrappedHeight.matches("[0-9].[0-9]{1,2}") || unwrappedHeight.matches("[0-9]'") || unwrappedHeight.matches("[0-9]{1}") || unwrappedHeight.matches("[0-9]{1}.")) && unwrappedWeight.matches("[0-9]+") && unwrappedAge.matches("[0-9]+")
    ...
    */
    ...
    @objc func registerPhysicalStats() {
        ...
        let height = (heightString.matches("[0-9].[0-9]{1,2}") || heightString.matches("[0-9]'") || heightString.matches("[0-9]{1}") || heightString.matches("[0-9]{1}.")) ? heightString : nil
